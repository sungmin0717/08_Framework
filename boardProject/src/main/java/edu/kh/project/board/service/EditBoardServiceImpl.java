...
public class EditBoardServiceImpl implements EditBoardService{
	...
	// 게시글 삭제
	@Override
	public int Delete(int boardNo, int memberNo) {
		
		int Delete = mapper.Delete(boardNo, memberNo);
