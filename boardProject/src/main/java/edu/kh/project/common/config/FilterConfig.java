...
/*사용할 필터 클래스르 Bean으로 등록 + 적용될 요청 주소 설정*/
...
public class FilterConfig {
	...
	public FilterRegistrationBean<SignUpFilter> signUpFilter() {
		...
		//FilterRegistrationBean 필터를 등록하는 객체
		...
		// 필터가 동작할 요청 경로 패턴 지정
		String[] filteringUrl = {"/member/signUp"}; // member.signUp에서 동작하게 만들기
		filter.setUrlPatterns( Arrays.asList(filteringUrl) );
		
		//필터 이름 지정
		filter.setName("singUpFilter");
